...
class OlaHubAdvertisesController extends BaseController
{
    ...
    private function checkSlugs()
    {
        ...
        } elseif ((array_key_exists('designerSlug', $this->requestFilter) && strlen($this->requestFilter['designerSlug']) > 0)) {
            $this->mainModule = 'designer';
            $this->return = \OlaHub\UserPortal\Models\Designer::getDesignerBySlug($this->requestFilter['designerSlug']);
