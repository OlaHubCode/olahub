...
class OlaHubHeaderMenuController extends BaseController
{
    ...
    public function getStores()
    {
        ...
        $designersModel->whereHas('itemsMainData', function ($query) {
            $query->where('is_published', '1');
        });
        $brands = $brandsModel->get();
        ...
        $designers = \OlaHub\UserPortal\Helpers\CommonHelper::handlingResponseCollection($designers, '\OlaHub\UserPortal\ResponseHandlers\HomePageDesignersHandler');
