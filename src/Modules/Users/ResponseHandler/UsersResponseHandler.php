...
class UsersResponseHandler extends Fractal\TransformerAbstract {
    ...
    private function setUserInterests() {
       $interestsData = [];
       $interestsText = [];
    //    if(isset($intersts) && $intersts){
    //        $interests = \OlaHub\UserPortal\Models\Interests::withoutGlobalScope('interestsCountry')->whereIn('interest_id',$intersts)->get();
    ...
    //        }
    //    }
       $this->return["userInterests"] = 'new code';
       $this->return["userInterestsText"] = 'new code';
